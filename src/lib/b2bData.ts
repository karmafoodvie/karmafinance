// Statische B2B-Kanaldaten aus Odoo sale.order Export (Aug 2024 – Sep 2026).
// Reine Datei ohne "use client" — kann von Server- UND Client-Komponenten importiert werden.
