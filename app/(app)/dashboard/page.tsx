    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 mb-6">
        <StatTile
          ...
          sub="Shops + Shopify + Lieferdienste + TGTG"
          yoy={kpis.totalYoy}
          info={`Summe aus allen Einkommensströmen für ${rangeEndLabel} (das Ende des gewählten Zeitraums): Shops (Lunch-Locations), Shopify-Webshop, Lieferdienste (Wolt + Foodora) und Too Good To Go (netto, nach TGTG-Gebühr).`}
        />
        <StatTile
          label="Shops"
      ...
      <Card>
        <CardHeader
          ...
          subtitle={`Shops vs. Shopify vs. Lieferdienste vs. TGTG, pro Monat (${rangeStartLabel} – ${rangeEndLabel})`}
        />
